# AeroDrag — Prompt di comando: chat figlia «firmware ESP32-S3»
...
## Blocco specifico — firmware ESP32-S3

```
Dominio: firmware del device ESP32-S3. Implementi §2/§3/§5/§6 (servizi/caratteristiche
BLE GATT, timebase, identità/pairing) per l'ESP32, conformi al contratto ratificato.
Ricorda: questo repo OSPITA docs/CONTRACT.md ma NON lo edita — solo MOTHER.
TASK: <descrivi qui l'incarico firmware>
```
